...
export function FloatingCart({ totalItems, totalPrice }: FloatingCartProps) {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 left-4 right-4 z-50 flex items-center justify-between px-6 py-4 bg-gold rounded-2xl shadow-xl hover:bg-gold-hover transition-colors webapp-button"
    >
